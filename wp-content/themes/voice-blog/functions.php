...
function voice_blog_modal() {
	if(absint(get_theme_mod('voice_blog_blog_post_post_taxonomy_'.__('Read more','voice-blog'),'1'))==1): ?>
		<?php if(absint(get_theme_mod('voice_blog_popup_enable','1'))==1): ?>
			<a class=" btn <?php if ( esc_attr(get_theme_mod('voice_blog_blog_post_layout','2'))==1 ) {echo 'mt-4'; } else { echo 'float-left' ;} ?>" data-toggle="modal" data-target="#post-content-<?php the_ID(); ?>"><?php echo esc_html(get_theme_mod('voice_blog_read_more_title',__('Read More', 'voice-blog'))); ?></a>
			<!-- Modal -->
